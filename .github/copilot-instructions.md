...
- Symfony form type and assets for **Tiptap** rich-text editing (HTML stored in textarea).
- Vite-built frontend widget under `src/Resources/assets/`; keep dist output aligned with CI and demo smoke tests.
...
- Add or update PHPUnit and Vitest coverage for new behaviour; keep coverage in line with README and CI.
